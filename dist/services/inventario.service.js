...
export async function getInventario(params) {
    ...
    const bodega = params.bodega === null || params.bodega === undefined || params.bodega === ''
        ? null
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : 'Error desconocido ejecutando el SP';
